...
var huffmanHRTable = {
  40: "10000000", 41: "10000001", 42: "10000010", 43: "10000011", 44: "10000100",
  45: "10000101", 46: "10000110", 47: "10000111", 48: "10001000", 49: "10001001",
  50: "0100000", 51: "0100001", 52: "0100010", 53: "0100011", 54: "0100100",
  55: "0100101", 56: "0100110", 57: "0100111", 58: "0101000", 59: "0101001",
  ...
  100: "001111", 101: "0101010", 102: "0101011", 103: "0101100", 104: "0101101",
...
function onHRMRaw(hrm) {
  ...
  if (samplingTime - lastHRMTime >= sampleInterval / 1000) {
    ...
    if (recFile && lastHRM) {
      ...
      recFile.write([timestampToRecord.toFixed(2), encodedRaw, hrm.raw].join(",") + "\n");
